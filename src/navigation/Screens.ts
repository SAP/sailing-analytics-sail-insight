...
export const MarkTracking = 'MarkTracking'
...
export const RegisterBoatAfterRegistration = 'RegisterBoatAfterRegistration'
export const RegisterBoat = 'RegisterBoat'
export const Login = 'Login'
export const LoginFromSplash = 'LoginFromSplash'
