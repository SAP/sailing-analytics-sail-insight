export const ApiBodyKeys = {
  ...
  Type: 'type',
  DiscardIndexResultsStartingWithHowManyRaces: 'discardIndexResultsStartingWithHowManyRaces',
...
export const mapResToLeaderboard = (map: any) => map && ({
  ...
  discardIndexResultsStartingWithHowManyRaces: map[ApiBodyKeys.DiscardIndexResultsStartingWithHowManyRaces],
